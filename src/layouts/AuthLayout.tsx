...
export default function AuthLayout() {
    return (
        <div className="min-h-screen bg-base-app flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-indigo-900/20 via-neutral-950 to-neutral-950">
            <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
                ...
                <p className="mt-2 text-center text-sm text-text-muted max-w-sm mx-auto">
                    Centraliza tus listas de consumo cultural en una sola plataforma unificada.
                </p>
            </div>

            <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md relative z-10">
                <div className="bg-base-card/80 backdrop-blur-xl py-8 px-4 shadow-2xl sm:rounded-2xl sm:px-10 border border-base-border/10">
                    <Outlet />
                </div>
            </div>
